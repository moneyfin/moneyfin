...
For more information, please read the [Moneyfin privacy statement](https://privacy.moneyfin.com/privacystatement). 
...
- [C# events](https://github.com/search?q=repo%3Amoneyfin/moneyfin%20EventBase&type=code)
- [C++ events](https://github.com/search?q=repo%3Amoneyfin%2Fmoneyfin+ProjectTelemetryPrivacyDataTag&type=code)
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.UpdateDownload_Completed</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.OobeModuleRunEvent</td>
  ...
  <tr>
    <td>Moneyfin.moneyfin.OobeSectionEvent</td>
    <td>Occurs when OOBE is shown to the user.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.OobeSettingsEvent</td>
    <td>Triggers when a Settings page is opened from an OOBE page.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.OobeStartedEvent</td>
    <td>Indicates when the out-of-box experience has been initiated.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.OobeVariantAssignmentEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.AlwaysOnTop_EnableAlwaysOnTop</td>
    <td>Triggered when Always on Top is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.AlwaysOnTop_PinWindow</td>
    <td>Occurs when a window is pinned to stay on top of other windows.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.AlwaysOnTop_UnpinWindow</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.ColorPicker_EnableColorPicker</td>
    <td>Triggered when Color Picker is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ColorPicker_Session</td>
    <td>Occurs during a Color Picker usage session.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ColorPicker_Settings</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.CmdNotFound_EnableCmdNotFound</td>
    <td>Triggered when Command Not Found is enabled or disabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.CmdNotFoundInstallEvent</td>
    <td>Triggered when a Command Not Found is installed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.CmdNotFoundUninstallEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.CursorWrap_EnableCursorWrap</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.EnvironmentVariables_Activate</td>
    <td>Triggered when Environment Variables is launched.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.EnvironmentVariables_EnableEnvironmentVariables</td>
    <td>Occurs when Environment Variables is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.EnvironmentVariablesOpenedEvent</td>
    <td>Triggered when the Environment Variables interface is opened.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.EnvironmentVariablesProfileEnabledEvent</td>
    <td>Occurs when an environment variable profile is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.EnvironmentVariablesVariableChangedEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.FancyZones_CycleActiveZoneSet</td>
    <td>Triggered when the active zone set is cycled through.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FancyZones_EditorLaunch</td>
    <td>Occurs when the FancyZones editor is launched.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FancyZones_EnableFancyZones</td>
    <td>Occurs when FancyZones is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FancyZones_Error</td>
  ...
  <tr>
    <td>Moneyfin.moneyfin.FancyZonesEditorStartFinishEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.FileLocksmith_EnableFileLocksmith</td>
    <td>Triggered when File Locksmith is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FileLocksmith_Invoked</td>
    <td>Occurs when File Locksmith is invoked.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FileLocksmith_InvokedRet</td>
    <td>Triggered when File Locksmith invocation returns a result.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FileLocksmith_QueryContextMenuError</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.FindMyMouse_EnableFindMyMouse</td>
    <td>Triggered when Find My Mouse is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.FindMyMouse_MousePointerFocused</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.HostsFileEditor_Activate</td>
    <td>Triggered when Hosts File Editor is activated.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.HostsFileEditor_EnableHostsFileEditor</td>
    <td>Occurs when Hosts File Editor is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.HostsFileEditorOpenedEvent</td>
    <td>Fires when Hosts File Editor is opened.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.HostEditorStartEvent</td>
  ...
  <tr>
    <td>Moneyfin.moneyfin.HostEditorStartFinishEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.ImageResizer_EnableImageResizer</td>
    <td>Triggered when Image Resizer is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ImageResizer_Invoked</td>
    <td>Occurs when Image Resizer is invoked by the user.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ImageResizer_InvokedRet</td>
    <td>Fires when the Image Resizer operation is completed and returns a result.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ImageResizer_QueryContextMenuError</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.KeyboardManager_ErrorSendingKeyAndShortcutRemapLoadedConfiguration</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.LightSwitch_EnableLightSwitch</td>
    <td>Triggered when Light Switch is enabled or disabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.LightSwitch_ShortcutInvoked</td>
    <td>Occurs when the shortcut for Light Switch is invoked.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.LightSwitch_ScheduleModeToggled</td>
    <td>Occurs when a new schedule mode is selected for Light Switch.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.LightSwitch_ThemeTargetChanged</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.MouseHighlighter_EnableMouseHighlighter</td>
    <td>Triggered when Mouse Highlighter is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MouseHighlighter_StartHighlightingSession</td>
    <td>Occurs when a new highlighting session is started.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MouseHighlighter_StartSpotlightSession</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.MouseJump_EnableJumpTool</td>
    <td>Triggered when Mouse Jump is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MouseJump_InvokeJumpTool</td>
    <td>Occurs when Mouse Jump is invoked.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MouseJumpShowEvent</td>
    <td>Triggered when the Mouse Jump display is shown.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MouseJumpTeleportCursorEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.MousePointerCrosshairs_EnableMousePointerCrosshairs</td>
    <td>Triggered when Mouse Pointer Crosshairs is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MousePointerCrosshairs_StartDrawingCrosshairs</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_ChangedTemplateLocation</td>
    <td>Triggered when the template folder location is changed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_EventCopyTemplate</td>
    <td>Triggered when an item from New+ is created (copied to the current directory).</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_EventCopyTemplateResult</td>
    <td>Logs the success of item creation (copying).</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_EventOpenTemplates</td>
    <td>Triggered when the templates folder is opened.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_EventShowTemplateItems</td>
    <td>Triggered when the New+ context menu flyout is displayed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.NewPlus_EventToggleOnOff</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.Peek_Closed</td>
    <td>Triggered when Peek is closed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_EnablePeek</td>
    <td>Occurs when Peek is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_Error</td>
    <td>Triggered when an error occurs for Peek.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_InvokePeek</td>
    <td>Occurs when Peek is invoked.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_Opened</td>
    <td>Triggered when a Peek window is opened.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_OpenWith</td>
    <td>Occurs when an item is opened with Peek.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_Settings</td>
    <td>Triggered when the settings for Peek are modified.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Peek_SpaceModeEnabled</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_EnablePowerRename</td>
    <td>Triggered when PowerRename is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_Invoked</td>
    <td>Occurs when PowerRename is invoked.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_InvokedRet</td>
    <td>Triggered when the invocation of PowerRename returns a result.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_RenameOperation</td>
    <td>Triggered during the rename operation within PowerRename.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_SettingsChanged</td>
    <td>Occurs when the settings for PowerRename are changed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerRename_UIShownRet</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.PowerAccent_EnablePowerAccent</td>
    <td>Triggered when Quick Accent is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.PowerAccentShowAccentMenuEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.RegistryPreview_Activate</td>
    <td>Triggered when Registry Preview is activated.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.RegistryPreview_EnableRegistryPreview</td>
    <td>Occurs when Registry Preview is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.RegistryPreviewEditorStartEvent</td>
  ...
  <tr>
    <td>Moneyfin.moneyfin.RegistryPreviewEditorStartFinishEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.MeasureTool_BoundsToolActivated</td>
    <td>Triggered when Screen Ruler's Bounds tool is activated.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MeasureTool_EnableMeasureTool</td>
    <td>Occurs when Screen Ruler is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.MeasureTool_MeasureToolActivated</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.ShortcutGuide_GuideSession</td>
    <td>Logs a Shortcut Guide session including duration and how it was closed.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ShortcutGuide_Settings</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.Workspaces_CreateEvent</td>
    <td>Triggered when a new workspace is created.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Workspaces_DeleteEvent</td>
    <td>Triggered when a workspace is deleted.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Workspaces_EditEvent</td>
    <td>Triggered when a workspace is edited or modified.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Workspaces_Enable</td>
    <td>Indicates that Workspaces is enabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.Workspaces_LaunchEvent</td>
    <td>Triggered when a workspace is launched.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.WorkspacesEditorStartEvent</td>
  ...
  <tr>
    <td>Moneyfin.moneyfin.WorkspacesEditorStartFinishEvent</td>
...
<table style="width:100%; table-layout:fixed">
  ...
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_EnableZoomIt</td>
    <td>Triggered when ZoomIt is enabled/disabled.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_Started</td>
    <td>Triggered when the ZoomIt process starts.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateBreak</td>
    <td>Triggered when the Break mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateDraw</td>
    <td>Triggered when the Draw mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateZoom</td>
    <td>Triggered when the Zoom mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateLiveZoom</td>
    <td>Triggered when the Live Zoom mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateDemoType</td>
    <td>Triggered when the DemoType mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateRecord</td>
    <td>Triggered when the Record mode is entered.</td>
  </tr>
  <tr>
    <td>Moneyfin.moneyfin.ZoomIt_ActivateSnip</td>
